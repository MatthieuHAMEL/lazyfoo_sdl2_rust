...
fn prompt_error_and_panic(message: &str, error: &str, window: Option<&Window>) -> ! 
{
  show_simple_message_box(
      ...
      window,
        ...
        // So in a real application I'd be logging the error in a file before trying to create a message box 
...
fn main() -> Result<(), String> 
{
  ...
  // pointer to the surface, in C). Here we don't have an event loop so...
	...
	// Sleep 3s to see something on the screen. Of course it will freeze the window
